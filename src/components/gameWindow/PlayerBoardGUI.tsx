...
const PlayerBoardGUI = ({playerBoard}: GameProps) => {
  ...
  const [displayWords, setDisplayWords] = React.useState("Click to rearrange your ships!")
  ...
  const onMove = (Row: number, Col: number) => {
    ...
    // console.log("Ship to move", shipToMove);
     ...
     if(playerBoard.isValidPlacement(playerBoard.getShips[shipToMove], Row, Col) === false){ 
